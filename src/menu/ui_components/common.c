/**
 * @file common.c
 * @brief Implementation of common UI components.
...
/**
 * @brief Draw a filled rectangle (box) with the specified color.
 *
 ...
 * @param color Fill color of the box.
 */
...
/**
 * @brief Draw a border rectangle with the specified color.
 *
 * @param x0 X-coordinate of the top-left corner.
 * @param y0 Y-coordinate of the top-left corner.
 * @param x1 X-coordinate of the bottom-right corner.
...
/**
 * @brief Draw a border rectangle with the default border color.
 *
 * @param x0 X-coordinate of the top-left corner.
 * @param y0 Y-coordinate of the top-left corner.
 * @param x1 X-coordinate of the bottom-right corner.
...
/**
 * @brief Draw the main layout border and separator for tabbed layouts.
 */
...
/**
 * @brief Draw the main layout border and separator.
 */
...
/**
 * @brief Draw a seek bar at the default position.
 *
 * @param position Seek position value (0.0 to 1.0).
 */
...
/**
 * @brief Draw a loader with a progress bar and optional message.
 *
 * @param progress Progress value (0.0 to 1.0).
 * @param msg Message to display (truncated to 30 characters), or NULL for no message.
 */
 ...
 * @param position Current scroll position (item index).
...
/**
 * @brief Draw a list scrollbar at the default position.
 *
 * @param position Current scroll position (item index).
 * @param items Total number of items.
 * @param visible_items Number of visible items.
...
/**
 * @brief Draw a dialog box centered on the display.
 *
...
/**
 * @brief Draw a message box with formatted text (variadic arguments).
 *
...
/**
 * @brief Draw the main text with formatted content (variadic arguments).
 *
...
/**
 * @brief Draw the actions bar text with formatted content (variadic arguments).
 *
 * @param style Font style.
 * @param align Horizontal alignment.
 * @param valign Vertical alignment.
...
/**
 * @brief Draw a row of tabs with text labels.
 *
 * @param text Array of tab text labels.
 * @param count Number of tabs.
 * @param selected Index of the selected tab.
 * @param width Width of each tab.
 */
...
/**
 * @brief Draw a value editor with selectable fields.
 *
 * @param header_text Array of header text labels for each field.
 * @param value_text Array of value text labels for each field.
 * @param count Number of fields.
 * @param selected Index of the selected field.
 * @param width_adjustment Adjustment factor for field width.
 */
void ui_component_value_editor(const char **header_text, const char **value_text, int count, int selected, float width_adjustment) {
    ...
    // Draw border around value boxes
    ui_components_border_draw(starting_x, y, x, y + height + 24);
}
